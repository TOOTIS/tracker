...
class ShiftsControllerTest < ActionController::TestCase
  ...
  test "should create shift" do
    assert_difference('Shift.count') do
      post :create, shift: { commit: @shift.commit, day: @shift.day, desc: @shift.desc, hours: @shift.hours }
    end
  ...
  test "should update shift" do
    patch :update, id: @shift, shift: { commit: @shift.commit, day: @shift.day, desc: @shift.desc, hours: @shift.hours }
    assert_redirected_to shift_path(assigns(:shift))
  end
